...
_planning_agent_instance = None  # Variable global para almacenar la instancia

def create_planning_agent(llm, vectorstores: Dict[str, Chroma]):
    """
    Crea un agente especializado en planificaciones educativas (Singleton).
    ...
    if _planning_agent_instance is None:
        ...
        _planning_agent_instance = planning_agent_executor
